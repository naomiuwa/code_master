  ...
  return (
    <div>
      ...
      <h2 className="description">
        Think you're a coding master? <br></br>
        <br></br>Test yourself with our range of quizzes! Select a topic below
        to be taken to its quiz page.
      </h2>
      <div className="resources-display">
        <div className="topic">
          <a href="../Test/Quiz">General </a>
        </div>
